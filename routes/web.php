...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['middleware' => 'checkRole:superadmin,admin gudang,kepala gudang'], function () {
        ...
        Route::get('/forecast/get-data', [ForecastController::class, 'getData']);
        Route::get('/forecast/analytics', [ForecastController::class, 'analytics']);
        Route::delete('/forecast/delete-all', [ForecastController::class, 'deleteAll']);
