...
@section('content')
    ...
    <div class="section-header">
        <h1>📋 Jenis Barang</h1>
        <div class="ml-auto">
            <a href="javascript:void(0)" class="btn btn-primary" id="button_tambah_jenis_barang"><i class="fa fa-plus"></i> <span class="d-none d-md-inline">Tambah Jenis Barang</span></a>
        </div>
    </div>
                        ...
                        <table id="table_id" class="display w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th style="min-width: 200px;">Jenis Barang</th>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                <tr class="barang-row" id="index_${value.id}">
                    <td>${counter++}</td>   
                    <td><strong>${value.jenis_barang}</strong></td>
                    <td>
                        <div class="action-buttons">
                            <a href="javascript:void(0)" id="button_edit_jenis_barang" data-id="${value.id}" class="btn btn-sm btn-warning" title="Edit"><i class="far fa-edit"></i></a>
                            <a href="javascript:void(0)" id="button_hapus_jenis_barang" data-id="${value.id}" class="btn btn-sm btn-danger" title="Hapus"><i class="fas fa-trash"></i></a>
                        </div>
                    </td>
                </tr>
            `;
