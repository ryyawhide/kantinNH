...
@section('content')
    ...
    <div class="section-header">
        <h1>📥 Barang Masuk</h1>
        <div class="ml-auto">
            <a href="javascript:void(0)" class="btn btn-primary" id="button_tambah_barangMasuk"><i class="fa fa-plus"></i> <span class="d-none d-md-inline">Barang Masuk</span></a>
        </div>
    </div>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                <tr class="barang-row" id="index_${value.id}">
                    ...
                    <td><span class="badge badge-success">${value.jumlah_masuk}</span></td>
                    <td>${supplier}</td>
                    <td>
                        <a href="javascript:void(0)" id="button_hapus_barangMasuk" data-id="${value.id}" class="btn btn-sm btn-danger" title="Hapus"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            `;
