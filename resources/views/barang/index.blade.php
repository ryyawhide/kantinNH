...
@section('content')
    ...
    <div class="section-header">
        <h1>📦 Data Barang</h1>
        <div class="ml-auto">
            <a href="javascript:void(0)" class="btn btn-primary" id="button_tambah_barang"><i class="fa fa-plus"></i> <span class="d-none d-md-inline">Tambah Barang</span></a>
        </div>
    </div>
                ...
                <tr class="barang-row" id="index_${value.id}">
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="javascript:void(0)" id="button_detail_barang" data-id="${value.id}" class="btn btn-sm btn-info" title="Detail"><i class="far fa-eye"></i></a>
                            <a href="javascript:void(0)" id="button_edit_barang" data-id="${value.id}" class="btn btn-sm btn-warning" title="Edit"><i class="far fa-edit"></i></a>
                            <a href="javascript:void(0)" id="button_hapus_barang" data-id="${value.id}" class="btn btn-sm btn-danger" title="Hapus"><i class="fas fa-trash"></i></a>
                        </div>
                    </td>
                </tr>
            `;
