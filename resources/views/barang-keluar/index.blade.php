...
@section('content')
    ...
    <div class="section-header">
        <h1>📤 Barang Keluar</h1>
        <div class="ml-auto">
            <a href="javascript:void(0)" class="btn btn-primary" id="button_tambah_barangKeluar"><i class="fa fa-plus"></i> <span class="d-none d-md-inline">Barang Keluar</span></a>
        </div>
    </div>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                <tr class="barang-row" id="index_${value.id}">
                    <td>${counter++}</td>   
                    <td><strong>${value.kode_transaksi}</strong></td>
                    <td>${value.tanggal_keluar}</td>
                    <td>${value.nama_barang}</td>
                    <td><span class="badge badge-danger">${value.jumlah_keluar}</span></td>
                    <td>${customer}</td>
                    <td>       
                        <a href="javascript:void(0)" id="button_hapus_barangKeluar" data-id="${value.id}" class="btn btn-sm btn-danger" title="Hapus"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
            `;
